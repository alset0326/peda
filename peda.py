...
class PEDA(object):
    ...
    def set_breakpoint(self, location, temp=False, hard=False):
        """
...
class PEDACmd(object):
    ...
    def eflags(self, *arg):
        ...
        if option == "set":
            peda.set_eflags(flagname.lower(), True)
        elif option == "clear":
...
if zlib:
    ...
    msg('PEDA modified by alset v1.0'.rjust(random.randint(10, 50)), 'red')
    msg('')
